...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/BlogBundle/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/BlogBundle/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/var/www/BlogBundle/app/Resources/FrameworkBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SecurityBundle', '/var/www/BlogBundle/app/Resources/SecurityBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SecurityBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/var/www/BlogBundle/app/Resources/TwigBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MonologBundle', '/var/www/BlogBundle/app/Resources/MonologBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MonologBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/MonologBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SwiftmailerBundle', '/var/www/BlogBundle/app/Resources/SwiftmailerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SwiftmailerBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/SwiftmailerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/var/www/BlogBundle/app/Resources/DoctrineBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/DoctrineBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AsseticBundle', '/var/www/BlogBundle/app/Resources/AsseticBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AsseticBundle', '/var/www/BlogBundle/vendor/bundles/Symfony/Bundle/AsseticBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioFrameworkExtraBundle', '/var/www/BlogBundle/app/Resources/SensioFrameworkExtraBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioFrameworkExtraBundle', '/var/www/BlogBundle/vendor/bundles/Sensio/Bundle/FrameworkExtraBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSSecurityExtraBundle', '/var/www/BlogBundle/app/Resources/JMSSecurityExtraBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSSecurityExtraBundle', '/var/www/BlogBundle/vendor/bundles/JMS/SecurityExtraBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', '/var/www/BlogBundle/app/Resources/FOSUserBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', '/var/www/BlogBundle/vendor/bundles/FOS/UserBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSCommentBundle', '/var/www/BlogBundle/app/Resources/FOSCommentBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSCommentBundle', '/var/www/BlogBundle/vendor/bundles/FOS/CommentBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KnpMenuBundle', '/var/www/BlogBundle/app/Resources/KnpMenuBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'KnpMenuBundle', '/var/www/BlogBundle/vendor/bundles/Knp/Bundle/MenuBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SonatajQueryBundle', '/var/www/BlogBundle/app/Resources/SonatajQueryBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SonatajQueryBundle', '/var/www/BlogBundle/src/Sonata/jQueryBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SonataAdminBundle', '/var/www/BlogBundle/app/Resources/SonataAdminBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SonataAdminBundle', '/var/www/BlogBundle/src/Sonata/AdminBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'D2NitBlogBundle', '/var/www/BlogBundle/app/Resources/D2NitBlogBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'D2NitBlogBundle', '/var/www/BlogBundle/src/D2Nit/BlogBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/var/www/BlogBundle/app/Resources/AcmeDemoBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/var/www/BlogBundle/src/Acme/DemoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/BlogBundle/app/Resources/WebProfilerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioDistributionBundle', '/var/www/BlogBundle/app/Resources/SensioDistributionBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioDistributionBundle', '/var/www/BlogBundle/vendor/bundles/Sensio/Bundle/DistributionBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioGeneratorBundle', '/var/www/BlogBundle/app/Resources/SensioGeneratorBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioGeneratorBundle', '/var/www/BlogBundle/vendor/bundles/Sensio/Bundle/GeneratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/var/www/BlogBundle/app/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/BlogBundle/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'd2nit.blog.admin.article' service.
     *
     * @return D2Nit\BlogBundle\Admin\ArticleAdmin A D2Nit\BlogBundle\Admin\ArticleAdmin instance.
     */
    protected function getD2nit_Blog_Admin_ArticleService()
    {
        $instance = new \D2Nit\BlogBundle\Admin\ArticleAdmin('d2nit.blog.admin.article', 'D2Nit\\BlogBundle\\Entity\\Article', 'D2NitBlogBundle:ArticleAdmin');
        ...
        $instance->setViewBuilder($this->get('sonata.admin.builder.orm_view'));
    ...
    /**
     * Gets the 'd2nit.blog.admin.category' service.
     *
     * @return D2Nit\BlogBundle\Admin\CategoryAdmin A D2Nit\BlogBundle\Admin\CategoryAdmin instance.
     */
    protected function getD2nit_Blog_Admin_CategoryService()
    {
        $instance = new \D2Nit\BlogBundle\Admin\CategoryAdmin('d2nit.blog.admin.category', 'D2Nit\\BlogBundle\\Entity\\Category', 'D2NitBlogBundle:CategoryAdmin');
    ...
    /**
     * Gets the 'd2nit.blog.admin.comment' service.
     *
     * @return D2Nit\BlogBundle\Admin\CommentAdmin A D2Nit\BlogBundle\Admin\CommentAdmin instance.
     */
    protected function getD2nit_Blog_Admin_CommentService()
    {
        $instance = new \D2Nit\BlogBundle\Admin\CommentAdmin('d2nit.blog.admin.comment', 'D2Nit\\BlogBundle\\Entity\\Comment', 'D2NitBlogBundle:CommentAdmin');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'blog', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => 'root', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_771aeb02687b8cf0eff8e4819c0c7c73');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_771aeb02687b8cf0eff8e4819c0c7c73');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_771aeb02687b8cf0eff8e4819c0c7c73');

        $d = new \Symfony\Bridge\Doctrine\Mapping\Driver\XmlDriver(array(0 => '/var/www/BlogBundle/vendor/bundles/FOS/CommentBundle/Resources/config/doctrine'));
        $d->setNamespacePrefixes(array('/var/www/BlogBundle/vendor/bundles/FOS/CommentBundle/Resources/config/doctrine' => 'FOS\\CommentBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'FOS\\CommentBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($this->get('annotation_reader')), array(0 => '/var/www/BlogBundle/src/D2Nit/BlogBundle/Entity')), 'D2Nit\\BlogBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('FOSCommentBundle' => 'FOS\\CommentBundle\\Entity', 'D2NitBlogBundle' => 'D2Nit\\BlogBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/BlogBundle/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/BlogBundle/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '07a52b4d54d5d6e0204eb7518615ad0f6a80a8d3');
    }
    ...
    /**
     * Gets the 'fos_comment.blamer.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\CommentBundle\Blamer\NoopCommentBlamer A FOS\CommentBundle\Blamer\NoopCommentBlamer instance.
     */
    protected function getFosComment_Blamer_CommentService()
    {
        return $this->services['fos_comment.blamer.comment'] = new \FOS\CommentBundle\Blamer\NoopCommentBlamer();
    }

    /**
     * Gets the 'fos_comment.blamer.vote' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\CommentBundle\Blamer\NoopVoteBlamer A FOS\CommentBundle\Blamer\NoopVoteBlamer instance.
     */
    protected function getFosComment_Blamer_VoteService()
    {
        return $this->services['fos_comment.blamer.vote'] = new \FOS\CommentBundle\Blamer\NoopVoteBlamer();
    }

    /**
     * Gets the 'fos_comment.creator.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\CommentBundle\Creator\DefaultCommentCreator A FOS\CommentBundle\Creator\DefaultCommentCreator instance.
     */
    protected function getFosComment_Creator_CommentService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('fos_comment.creator.comment', 'request');
        }

        return $this->services['fos_comment.creator.comment'] = $this->scopedServices['request']['fos_comment.creator.comment'] = new \FOS\CommentBundle\Creator\DefaultCommentCreator($this->get('fos_comment.manager.comment.default'), $this->get('fos_comment.blamer.comment'), $this->get('fos_comment.spam_detection.comment'));
    }

    /**
     * Gets the 'fos_comment.creator.thread' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\CommentBundle\Creator\DefaultThreadCreator A FOS\CommentBundle\Creator\DefaultThreadCreator instance.
     */
    protected function getFosComment_Creator_ThreadService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('fos_comment.creator.thread', 'request');
        }

        return $this->services['fos_comment.creator.thread'] = $this->scopedServices['request']['fos_comment.creator.thread'] = new \FOS\CommentBundle\Creator\DefaultThreadCreator($this->get('request'), $this->get('fos_comment.manager.thread.default'));
    }

    /**
     * Gets the 'fos_comment.creator.vote' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\CommentBundle\Creator\DefaultVoteCreator A FOS\CommentBundle\Creator\DefaultVoteCreator instance.
     */
    protected function getFosComment_Creator_VoteService()
    {
        return $this->services['fos_comment.creator.vote'] = new \FOS\CommentBundle\Creator\DefaultVoteCreator($this->get('fos_comment.manager.vote.default'), $this->get('fos_comment.blamer.vote'), $this->get('validator'));
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('fos_comment.entity_manager'), 'D2Nit\\BlogBundle\\Entity\\Comment', $this->get('fos_comment.sorting_factory'));
    }
    ...
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('fos_comment.entity_manager'), 'D2Nit\\BlogBundle\\Entity\\Article');
    }
    ...
    {
        return $this->services['fos_comment.manager.vote.default'] = new \FOS\CommentBundle\Entity\VoteManager($this->get('fos_comment.entity_manager'), 'FOS\\CommentBundle\\Entity\\Vote');
    }
    ...
    /**
     * Gets the 'fos_comment.spam_detection.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return FOS\CommentBundle\SpamDetection\NoopSpamDetection A FOS\CommentBundle\SpamDetection\NoopSpamDetection instance.
     */
    protected function getFosComment_SpamDetection_CommentService()
    {
        return $this->services['fos_comment.spam_detection.comment'] = new \FOS\CommentBundle\SpamDetection\NoopSpamDetection();
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('D2Nit\\BlogBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('D2Nit\\BlogBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Entity\UserManager($this->get('security.encoder_factory'), 'sha512', $this->get('fos_user.util.username_canonicalizer'), $this->get('fos_user.util.email_canonicalizer'), $this->get('doctrine')->getEntityManager(NULL), 'D2Nit\\BlogBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/BlogBundle/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/var/www/BlogBundle/app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/BlogBundle/app/config/routing_dev.yml', array('cache_dir' => '/var/www/BlogBundle/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'main', $b, $c), 2 => $e, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'main', array('check_path' => '/login_check', 'login_path' => '/login', 'use_forward' => false, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), NULL, NULL, $b, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '4e391e43ec360', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'secured_area', $b, $c), 2 => $e, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'secured_area', array('check_path' => '/demo/secured/login_check', 'login_path' => '/demo/secured/login', 'use_forward' => false, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), NULL, NULL, $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $d, '/demo/secured/login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/BlogBundle/app');
    }
    ...
    {
        return $this->services['sonata.admin.builder.orm_datagrid'] = new \Sonata\AdminBundle\Builder\ORM\DatagridBuilder($this->get('form.factory'));
    }
    ...
    {
        return $this->services['sonata.admin.builder.orm_list'] = new \Sonata\AdminBundle\Builder\ORM\ListBuilder();
    }

    /**
     * Gets the 'sonata.admin.builder.orm_view' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Sonata\AdminBundle\Builder\ORM\ViewBuilder A Sonata\AdminBundle\Builder\ORM\ViewBuilder instance.
     */
    protected function getSonata_Admin_Builder_OrmViewService()
    {
        return $this->services['sonata.admin.builder.orm_view'] = new \Sonata\AdminBundle\Builder\ORM\ViewBuilder();
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'd2nit.blog.admin.article', 1 => 'd2nit.blog.admin.category', 2 => 'd2nit.blog.admin.comment'));
        $instance->setAdminGroups(array('d2nit_blog' => array('d2nit.blog.admin.article' => array('show_in_dashboard' => true), 'd2nit.blog.admin.category' => array('show_in_dashboard' => true), 'd2nit.blog.admin.comment' => array('show_in_dashboard' => true))));
        $instance->setAdminClasses(array('D2Nit\\BlogBundle\\Entity\\Article' => 'd2nit.blog.admin.article', 'D2Nit\\BlogBundle\\Entity\\Category' => 'd2nit.blog.admin.category', 'D2Nit\\BlogBundle\\Entity\\Comment' => 'd2nit.blog.admin.comment'));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'd2nit.blog.admin.article', 1 => 'd2nit.blog.admin.category', 2 => 'd2nit.blog.admin.comment'), $this);
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/BlogBundle/app');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/var/www/BlogBundle/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/BlogBundle/app/cache/dev/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \FOS\CommentBundle\Twig\Extension());
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/TwigBundle/DependencyInjection/../../../Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), '/var/www/BlogBundle/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/BlogBundle/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/BlogBundle/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml', 1 => '/var/www/BlogBundle/vendor/bundles/FOS/UserBundle/Resources/config/validation.xml', 2 => '/var/www/BlogBundle/vendor/bundles/FOS/CommentBundle/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/BlogBundle/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/BlogBundle/app/cache/dev',
            'kernel.logs_dir' => '/var/www/BlogBundle/app/logs',
            'kernel.bundles' => array(
                ...
                'D2NitBlogBundle' => 'D2Nit\\BlogBundle\\D2NitBlogBundle',
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => '07a52b4d54d5d6e0204eb7518615ad0f6a80a8d3',
            ...
            'debug.container.dump' => '/var/www/BlogBundle/app/cache/dev/appDevDebugProjectContainer.xml',
            'kernel.secret' => '07a52b4d54d5d6e0204eb7518615ad0f6a80a8d3',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/BlogBundle/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml',
                1 => '/var/www/BlogBundle/vendor/bundles/FOS/UserBundle/Resources/config/validation.xml',
                2 => '/var/www/BlogBundle/vendor/bundles/FOS/CommentBundle/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'sqlite:/var/www/BlogBundle/app/cache/dev/profiler.db',
            ...
            'router.resource' => '/var/www/BlogBundle/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/BlogBundle/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/var/www/BlogBundle/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/var/www/BlogBundle/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/BlogBundle/app/../web',
            'assetic.write_to' => '/var/www/BlogBundle/app/../web',
            ...
            'fos_user.model.user.class' => 'D2Nit\\BlogBundle\\Entity\\User',
            ...
            'fos_comment.model.thread.class' => 'D2Nit\\BlogBundle\\Entity\\Article',
            'fos_comment.model.comment.class' => 'D2Nit\\BlogBundle\\Entity\\Comment',
